...
var calcRepeatedDays = function (ctask, dayDelta) {
    ...
    if (ctask.startDate && !ctask.dueDate) {
        ...
        ctask.startDate = groundDate;   // setDate can't work accross month. We must pull it up to grounddate, first.
    ...
    if (!ctask.startDate && ctask.dueDate) {
        ...
        ctask.dueDate = groundDate;   // setDate can't work accross month. We must pull it up to grounddate, first.
